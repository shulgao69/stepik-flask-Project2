days = {"mon": "Понедельник", "tue": "Вторник", "wed": "Среда", "thu": "Четверг", "fri": "Пятница", "sat": "Суббота", "sun": "Воскресение"}

goals = {"travel": "Для путешествий", "study": "Для учебы", "work": "Для работы", "relocate": "Для переезда", "programm": "Для программирования"}
...
teachers = [
...

    {
        ...
        "rating": 4.7,
        "price": 1100,
        "goals": ["travel", "study", "work", "programm"],
        "free": {
